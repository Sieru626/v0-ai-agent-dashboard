    ...
    <header className={`flex items-center justify-between px-4 py-2 border-b-2 ${borderClass} bg-[#0a0a0a]`}>
      <div className="flex items-center gap-4">
        <button
          ...
          className="flex items-center gap-1 px-2 py-1 border border-[#333] text-[9px] text-neon-cyan hover:border-neon-cyan hover:bg-[#0a1520] transition-colors"
        >
        ...
        <div className="flex items-center gap-2">
          ...
          <h1 className={`text-[10px] ${textClass} tracking-wider`}>
            {roomNameEn}
          </h1>
